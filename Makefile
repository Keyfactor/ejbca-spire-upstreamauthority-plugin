...
help:
	...
	@echo "  $(cyan)build$(reset)                                 - build the EJBCA UpstreamAuthority binary (default)"
	@echo
...
binaries := ejbca-spire-upstreamauthority-plugin
...
tool_versions := $(shell curl -sSfL "https://raw.githubusercontent.com/spiffe/spire/main/.spire-tool-versions")
...
# correct go binary.
go-check:
	$(E)curl -sSfL "https://raw.githubusercontent.com/spiffe/spire/main/.go-version" -o .go-version
